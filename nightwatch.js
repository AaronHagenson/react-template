...
// create a globals file if it doesn't exist
const fs = require('fs');
...
if (!fs.existsSync(nightwatchGlobalsFile)) {
  ...
  const _global = 'module.exports = {' + endOfLine + tab + 'token_hash: null' + endOfLine + '};';
...
const nightwatchConfig = {
  ...
  phantomjs: {
    driver_path: './node_modules/phantomjs/bin/phantomjs'
  }
};
...
if (isWindows()) {
  nightwatchConfig.chrome.driver_path = "./bin/chromedriver.exe";
} else {
  nightwatchConfig.chrome.driver_path = "./bin/chromedriver";
}
