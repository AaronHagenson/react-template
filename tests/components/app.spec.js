import {App, mapStateToProps, mapDispatchToProps} from '../../src/components/app';
...
describe('App', () => {
  ...
  it('should render', () => {
    ...
    expect(wrapper.find('div').at(0).hasClass('container-fluid')).toBe(true);
    expect(wrapper.find('div').at(1).hasClass('navbar-spacer')).toBe(true);
  });
  ...
  describe('mapDispatchToProps', () => {
    it('should map retrieveProfile', () => {
      ...
      const retrieveStub = sinon.stub(actions, 'retrieveProfile').callsFake(() => {
        return '123';
      });
      const dispatch = arg => {
        return arg;
